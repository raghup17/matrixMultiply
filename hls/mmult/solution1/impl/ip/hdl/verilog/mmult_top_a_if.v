...
//------------------------Instantiation------------------
// mmult_top_a_request_preprocessor
mmult_top_a_request_preprocessor #(
...
module mmult_top_a_request_preprocessor/*{{{*/
#(parameter
    C_USER_DATA_WIDTH = 8
)(
    // system signal
...
module mmult_top_a_read_data_align/*{{{*/
#(parameter
    C_DATA_WIDTH      = 32,
    C_USER_DATA_WIDTH = 8
)(
